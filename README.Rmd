...
[![CRAN status](https://www.r-pkg.org/badges/version/plCFA)](https://CRAN.R-project.org/package=plCFA)
<!-- badges: end -->

The plCFA deals with the estimation of confirmatory factor models for ordinal data.
